...
- **Color Palette:** High-contrast **rainbow color sequence** spanning exactly one full set across all 16 numbers (15 down to 0). It starts with **Red** for 15, moves through orange, yellow, green, blue, indigo, and ends with **Violet** for 0.
